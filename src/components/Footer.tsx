        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-[#C9A962]/20 rounded-full flex items-center justify-center hover:bg-[#C9A962] transition-colors duration-300 group">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/layanan" className="text-gray-400 hover:text-[#C9A962] transition-colors duration-300 text-sm">
                  Haircut Classic
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-[#C9A962]/10 rounded-lg border border-[#C9A962]/20">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-400">
            <p>&copy; 2025 Gentleman&apos;s Cut Barbershop. All rights reserved.</p>
            <p>
